...
namespace gdraw {
    ...
    SDL_GPUShader* Material::LoadShader(const str& shaderFilename, u32 samplerCount,
        ...
        else if (SDL_strstr(shaderFilename.c_str(), ".frag")) { stage = SDL_GPU_SHADERSTAGE_FRAGMENT; }
        else {
    ...
    void Material::CreateSampler(TextureFilter filter, TextureWrap wrap) {
        SDL_GPUSamplerCreateInfo createInfo {
                ...
                .mipmap_mode = filter == TextureFilter::Nearest ? SDL_GPU_SAMPLERMIPMAPMODE_NEAREST
    ...
    void Material::LoadShader(const str& vertexShaderFilename, const str& fragmentShaderFilename, u32 samplerCount,
                              u32 uniformBufferCount, u32 storageBufferCount, u32 storageTextureCount) {
